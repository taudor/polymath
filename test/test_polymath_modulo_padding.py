...
class TestPolyModPad(unittest.TestCase):

    def test_01(self):
        test_array = array([1], dtype=int8)
        f = array([1, 0, 1, 0, 0, 1, 1, 0, 1], dtype=int8)
        assert_array_equal(
            polymath.polymodpad(test_array, f),
            array([0, 0, 0, 0, 0, 0, 0, 1], dtype=int8),
    ...
    def test_06(self):
        ...
        assert_array_equal(
            polymath.polymodpad(test_array, f),
            array([0, 0, 0, 0, 1, 0, 0, 1], dtype=int8),
    ...
    def test_07(self):
        ...
        assert_array_equal(
            polymath.polymodpad(test_array, f),
            array([0, 0, 0, 0, 0, 1, 1, 1], dtype=int8),
